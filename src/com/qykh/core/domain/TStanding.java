 ...
 */
@Entity
@Table(name = "t_standing")
public class TStanding implements java.io.Serializable {
	...
	/** full constructor */
	public TStanding(Integer id,String name,String num,String unit,Integer cid,String category,String creater,Integer sid,String supplier,String flag,Date intime,String certifier,String deperction,Double perPrice,Integer rate,String useStatus,Integer did,String dname,String operator,String place,String ext1,String ext7,String ext2,String ext3,String ext4,String ext5,String ext6) {
		this.id = id;
		this.name = name;
		this.num = num;
		this.unit = unit;
